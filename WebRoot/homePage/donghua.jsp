...
<div id="donghua" class="vv box">
					<a class="href" name="donghua"/>
	  				<div class="left sh_f">
	  					<div class="headline">
		  					<img src="/headline/donghua.png"/>
		  					<a href="../other.html" class="blue"><b>动画</b></a>
		  					<div class="type" style="display:none">动画</div>
	  					...
	  					<div class="video_box va1" style="display:block">
	  					
	  					</div>
	  					<div class="video_box va2">
	  				...
	  				<div class="right sh_f">
	  					...
	  					<div class="video_box va3" style="display:block;">
		  					
	  					</div>
	  					<div class="video_box va4">
